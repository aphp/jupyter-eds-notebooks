...
# Initializing shell hook scripts
...
# Initializing go-hdfs autocompletion if present
if [[ $(which hdfs) ]]; then 
    complete -o nospace -F _hdfs_complete hdfs
fi

# Initializing Starship prompt if present
